...
st.set_page_config(
    page_title="4567 Xe Ôm — Tài Xế (v4.7 Pro Stable)", page_icon="🛵", layout="centered"
)
...
# ============================================================
# XỬ LÝ TÍN HIỆU THANH TOÁN TỪ QUERY PARAMS (ĐẢM BẢO TOP WINDOW)
# ============================================================
...
# ============================================================
# ĐIỀU HƯỚNG CẤU TRÚC RẼ NHÁNH IF-ELIF
# ============================================================
