...
# ============================================================
# BẮT TÍN HIỆU THANH TOÁN TỪ JAVASCRIPT ĐỂ CHUYỂN BƯỚC 3 AN TOÀN
# ============================================================
...
# ============================================================
# ĐIỀU HƯỚNG CẤU TRÚC RẼ NHÁNH IF-ELIF (CHỈ MỘT MÀN HÌNH ĐƯỢC RENDER)
# ============================================================
...
# --- BƯỚC 2 & 3: KHU VỰC DÀNH CHO TÀI XẾ ĐÃ ĐĂNG NHẬP ---
else:
    # Header hiển thị thông tin tài xế kết hợp nút ĐĂNG XUẤT chuyên nghiệp
    ...
    # --- BƯỚC 2: MÀN HÌNH NHẬP KHÁCH & ĐO GPS HÀNH TRÌNH ---
